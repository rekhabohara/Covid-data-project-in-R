...
# predicting
test$PreditedCases <- predict(lm_model_GDP_cumCases, test)
...
R Square allows us to measure strength of the relationship between the response variable in the range 0.0 to 1.0.For RMSE, good means that the model generates accurate predictions with small residuals. In above two model Model2 is more preferred and good as per statistic output from each model.Low RMSE high R square , the best cases.  RMSE =24985.49, R-squared:  0.9139.
